...
settings_info settings_default = {
  ...
  /* tape_file */ (char *)NULL,
  /* tape_traps */ 1,
  /* teletext_addr_1 */ (char *)"127.0.0.1",
  /* teletext_addr_2 */ (char *)"127.0.0.1",
  /* teletext_addr_3 */ (char *)"127.0.0.1",
  /* teletext_addr_4 */ (char *)"127.0.0.1",
  /* teletext_port_1 */ 19761,
  /* teletext_port_2 */ 19762,
  /* teletext_port_3 */ 19763,
  /* teletext_port_4 */ 19764,
  /* ttx2000s */ 0,
  /* unittests */ 0,
  /* usource */ 0,
  /* uspeech */ 0,
...
parse_xml( xmlDocPtr doc, settings_info *settings )
{
  ...
  while( node ) {
    ...
    if( !strcmp( (const char*)node->name, "romttx2000s" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        libspectrum_free( settings->rom_ttx2000s );
        settings->rom_ttx2000s = utils_safe_strdup( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    ...
    if( !strcmp( (const char*)node->name, "teletextaddr1" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        libspectrum_free( settings->teletext_addr_1 );
        settings->teletext_addr_1 = utils_safe_strdup( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "teletextaddr2" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        libspectrum_free( settings->teletext_addr_2 );
        settings->teletext_addr_2 = utils_safe_strdup( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "teletextaddr3" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        libspectrum_free( settings->teletext_addr_3 );
        settings->teletext_addr_3 = utils_safe_strdup( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "teletextaddr4" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        libspectrum_free( settings->teletext_addr_4 );
        settings->teletext_addr_4 = utils_safe_strdup( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "teletextport1" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        settings->teletext_port_1 = atoi( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "teletextport2" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        settings->teletext_port_2 = atoi( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "teletextport3" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        settings->teletext_port_3 = atoi( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "teletextport4" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        settings->teletext_port_4 = atoi( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "ttx2000s" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        settings->ttx2000s = atoi( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
...
settings_write_config( settings_info *settings )
{
  ...
  if( settings->teletext_addr_1 )
    xmlNewTextChild( root, NULL, (const xmlChar*)"teletextaddr1", (const xmlChar*)settings->teletext_addr_1 );
  if( settings->teletext_addr_2 )
    xmlNewTextChild( root, NULL, (const xmlChar*)"teletextaddr2", (const xmlChar*)settings->teletext_addr_2 );
  if( settings->teletext_addr_3 )
    xmlNewTextChild( root, NULL, (const xmlChar*)"teletextaddr3", (const xmlChar*)settings->teletext_addr_3 );
  if( settings->teletext_addr_4 )
    xmlNewTextChild( root, NULL, (const xmlChar*)"teletextaddr4", (const xmlChar*)settings->teletext_addr_4 );
  snprintf( buffer, 80, "%d", settings->teletext_port_1 );
  xmlNewTextChild( root, NULL, (const xmlChar*)"teletextport1", (const xmlChar*)buffer );
  snprintf( buffer, 80, "%d", settings->teletext_port_2 );
  xmlNewTextChild( root, NULL, (const xmlChar*)"teletextport2", (const xmlChar*)buffer );
  snprintf( buffer, 80, "%d", settings->teletext_port_3 );
  xmlNewTextChild( root, NULL, (const xmlChar*)"teletextport3", (const xmlChar*)buffer );
  snprintf( buffer, 80, "%d", settings->teletext_port_4 );
  xmlNewTextChild( root, NULL, (const xmlChar*)"teletextport4", (const xmlChar*)buffer );
...
/*    *val_null = &settings->raw_rs232; */
  ...
  if( n == 11 && !strncmp( (const char *)name, "romttx2000s", n ) ) {
    *val_char = &settings->rom_ttx2000s;
    return 0;
  }
...
/*    *val_null = &settings->snapsasz80; */
  ...
  if( n == 13 && !strncmp( (const char *)name, "teletextaddr1", n ) ) {
    *val_char = &settings->teletext_addr_1;
    return 0;
  }
  if( n == 13 && !strncmp( (const char *)name, "teletextaddr2", n ) ) {
    *val_char = &settings->teletext_addr_2;
    return 0;
  }
  if( n == 13 && !strncmp( (const char *)name, "teletextaddr3", n ) ) {
    *val_char = &settings->teletext_addr_3;
    return 0;
  }
  if( n == 13 && !strncmp( (const char *)name, "teletextaddr4", n ) ) {
    *val_char = &settings->teletext_addr_4;
    return 0;
  }
  if( n == 13 && !strncmp( (const char *)name, "teletextport1", n ) ) {
    *val_int = &settings->teletext_port_1;
    return 0;
  }
  if( n == 13 && !strncmp( (const char *)name, "teletextport2", n ) ) {
    *val_int = &settings->teletext_port_2;
    return 0;
  }
  if( n == 13 && !strncmp( (const char *)name, "teletextport3", n ) ) {
    *val_int = &settings->teletext_port_3;
    return 0;
  }
  if( n == 13 && !strncmp( (const char *)name, "teletextport4", n ) ) {
    *val_int = &settings->teletext_port_4;
    return 0;
  }
  if( n == 8 && !strncmp( (const char *)name, "ttx2000s", n ) ) {
    *val_int = &settings->ttx2000s;
    return 0;
  }
...
settings_write_config( settings_info *settings )
{
  ...
  if( settings_string_write( doc, "romts20681",
    ...
    goto error;
  if( settings_string_write( doc, "romttx2000s",
                             settings->rom_ttx2000s ) )
    goto error;
  ...
  if( settings_boolean_write( doc, "tapetraps",
                              settings->tape_traps ) )
    goto error;
  if( settings_string_write( doc, "teletextaddr1",
                             settings->teletext_addr_1 ) )
    goto error;
  if( settings_string_write( doc, "teletextaddr2",
                             settings->teletext_addr_2 ) )
    goto error;
  if( settings_string_write( doc, "teletextaddr3",
                             settings->teletext_addr_3 ) )
    goto error;
  if( settings_string_write( doc, "teletextaddr4",
                             settings->teletext_addr_4 ) )
    goto error;
  if( settings_numeric_write( doc, "teletextport1",
                              settings->teletext_port_1 ) )
    goto error;
  if( settings_numeric_write( doc, "teletextport2",
                              settings->teletext_port_2 ) )
    goto error;
  if( settings_numeric_write( doc, "teletextport3",
                              settings->teletext_port_3 ) )
    goto error;
  if( settings_numeric_write( doc, "teletextport4",
                              settings->teletext_port_4 ) )
    goto error;
  if( settings_boolean_write( doc, "ttx2000s",
                              settings->ttx2000s ) )
    goto error;
...
settings_copy_internal( settings_info *dest, settings_info *src )
{
  ...
  dest->rom_ttx2000s = NULL;
  if( src->rom_ttx2000s ) {
    dest->rom_ttx2000s = utils_safe_strdup( src->rom_ttx2000s );
  }
  ...
  dest->teletext_addr_1 = NULL;
  if( src->teletext_addr_1 ) {
    dest->teletext_addr_1 = utils_safe_strdup( src->teletext_addr_1 );
  }
  dest->teletext_addr_2 = NULL;
  if( src->teletext_addr_2 ) {
    dest->teletext_addr_2 = utils_safe_strdup( src->teletext_addr_2 );
  }
  dest->teletext_addr_3 = NULL;
  if( src->teletext_addr_3 ) {
    dest->teletext_addr_3 = utils_safe_strdup( src->teletext_addr_3 );
  }
  dest->teletext_addr_4 = NULL;
  if( src->teletext_addr_4 ) {
    dest->teletext_addr_4 = utils_safe_strdup( src->teletext_addr_4 );
  }
  dest->teletext_port_1 = src->teletext_port_1;
  dest->teletext_port_2 = src->teletext_port_2;
  dest->teletext_port_3 = src->teletext_port_3;
  dest->teletext_port_4 = src->teletext_port_4;

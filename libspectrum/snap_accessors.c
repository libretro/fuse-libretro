...
libspectrum_snap_alloc( void )
{
  ...
  /* Which machine are we using here? */
  libspectrum_snap_set_machine( snap, LIBSPECTRUM_MACHINE_UNKNOWN );

  /* Registers and the like */
  libspectrum_snap_set_a( snap, 0 );
  libspectrum_snap_set_f( snap, 0 );
  libspectrum_snap_set_bc( snap, 0 );
  libspectrum_snap_set_de( snap, 0 );
  libspectrum_snap_set_hl( snap, 0 );
  libspectrum_snap_set_a_( snap, 0 );
  libspectrum_snap_set_f_( snap, 0 );
  libspectrum_snap_set_bc_( snap, 0 );
  libspectrum_snap_set_de_( snap, 0 );
  libspectrum_snap_set_hl_( snap, 0 );
  libspectrum_snap_set_ix( snap, 0 );
  libspectrum_snap_set_iy( snap, 0 );
  libspectrum_snap_set_i( snap, 0 );
  libspectrum_snap_set_r( snap, 0 );
  libspectrum_snap_set_sp( snap, 0 );
  libspectrum_snap_set_pc( snap, 0 );
  libspectrum_snap_set_memptr( snap, 0 );
  ...
  /* Peripheral status */
  libspectrum_snap_set_out_ula( snap, 0 );
  ...
  libspectrum_snap_set_out_scld_dec( snap, 0 );
  ...
  libspectrum_snap_set_zxcf_memctl( snap, 0 );
  ...
  libspectrum_snap_set_spectranet_paged( snap, 0 );
  libspectrum_snap_set_spectranet_paged_via_io( snap, 0 );
  libspectrum_snap_set_spectranet_nmi_flipflop( snap, 0 );
  libspectrum_snap_set_spectranet_programmable_trap_active( snap, 0 );
  libspectrum_snap_set_spectranet_programmable_trap_msb( snap, 0 );
  ...
  libspectrum_snap_set_spectranet_page_a( snap, 0 );
  libspectrum_snap_set_spectranet_page_b( snap, 0 );
  libspectrum_snap_set_spectranet_programmable_trap( snap, 0 );
...
libspectrum_snap_free( libspectrum_snap *snap )
{
  ...
  libspectrum_free( libspectrum_snap_opus_ram( snap, 0 ) );

  for( i = 0; i < SNAPSHOT_ZXATASP_PAGES; i++ )
    libspectrum_free( libspectrum_snap_zxatasp_ram( snap, i ) );
...
int
libspectrum_snap_ttx2000s_active( libspectrum_snap *snap )
{
  return snap->ttx2000s_active;
}

void
libspectrum_snap_set_ttx2000s_active( libspectrum_snap *snap, int ttx2000s_active )
{
  snap->ttx2000s_active = ttx2000s_active;
}
